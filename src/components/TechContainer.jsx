...
const technologies = [
  ...
  {id:'type', name:'Typescript', icon:<SiTypescript/>, desc:'Conhecimento básico', site:'https://developer.mozilla.org/pt-BR/docs/Learn/Tools_and_testing/Client-side_JavaScript_frameworks/Svelte_TypeScript'},
